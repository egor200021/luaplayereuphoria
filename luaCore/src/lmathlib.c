...
static int math_abs (lua_State *L) {
  lua_pushnumber(L, vfpu_abs(luaL_checknumber(L, 1)));
  return 1;
}
...
static int math_ceil (lua_State *L) {
  lua_pushnumber(L, vfpu_ceil(luaL_checknumber(L, 1)));
  return 1;
}

static int math_floor (lua_State *L) {
  lua_pushnumber(L, vfpu_floor(luaL_checknumber(L, 1)));
  return 1;
}
...
static int math_sqrt (lua_State *L) {
  lua_pushnumber(L, vfpu_sqrtf(luaL_checknumber(L, 1)));
  return 1;
}
...
static int math_log (lua_State *L) {
  lua_pushnumber(L, vfpu_logf(luaL_checknumber(L, 1)));
  return 1;
}

static int math_log10 (lua_State *L) {
  lua_pushnumber(L, vfpu_Log10(luaL_checknumber(L, 1)));
  return 1;
}
...
static int math_deg (lua_State *L) {
  lua_pushnumber(L, vfpu_Deg(luaL_checknumber(L, 1)));
  return 1;
}

static int math_rad (lua_State *L) {
  lua_pushnumber(L, vfpu_Rad(luaL_checknumber(L, 1)));
  return 1;
}
